...
mainLinkEl.insertAdjacentHTML('afterend', '<input id="font-size-control" type="range" /> <br /> <span id="text">Абракадабра!</span>');

const inputRangeEl = document.querySelector('input#font-size-control');
const textEl = document.querySelector('span#text');

const onRangeInput = (event) => {
    textEl.style.fontSize = `${parseInt(event.currentTarget.value)}px`;
};
